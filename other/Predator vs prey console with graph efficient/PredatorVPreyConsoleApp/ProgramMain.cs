...
namespace MyApp
{
    class ProgramMain
    {
        ...
        static public int formHeight = 100;
         static public int formWidth = 400;
        ...
        const int initialPrey = 400;
        const int initialPredator = 150;
        const int initialWater = 150;
        const int initialPlant = 150;
